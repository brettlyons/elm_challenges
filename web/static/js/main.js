...
var _user$project$Main$getRandomPos = F2(
	function (maxWidth, maxHeight) {
		return A2(
			...
			A2(
				...
				A2(_elm_lang$core$Random$int, 1, maxWidth),
				A2(_elm_lang$core$Random$int, 1, maxHeight)));
	});
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'NewCircle') {
			return {
				ctor: '_Tuple2',
			...
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: A2(_user$project$Main$getRandomPos, 400, 400)
			};
		}
	});
